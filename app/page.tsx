...
const perks = [
  {
    ...
    description:
      "Get your projects delivered to your email in seconds and download them right away.",
  },
  {
    name: "Guaranteed Quality",
    Icon: CheckCircle,
    description:
      "Every project on our platform is created by me to ensure out highest quality standards.",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
